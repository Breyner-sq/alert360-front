...
export default function NavBar() {
    return <div className="bg-white -z-10 p-4 gap-8 flex flex-col justify-between items-center drop-shadow-2xl">
        <Image className="size-8" src={"/menu.svg"} width={64} height={64} alt={""} />
